...
import {PORK_PLUS,PORK_MINUS,ADD_CART} from '../../Redux/shabuReducer'
...
const allPork = shabu.PorkDetail.map((porkMenu,key)=>{
return(
<div key={key}>
        ...
        <div className="flex justify-between">
          <div className="flex flex-row align-middle ">
            ...
            <div className="flex flex-col  ">
              ...
              <div className="flex flex-initial w-13 sm:w-32 flex-row justify-around shadow-inner items-center h-30 w-13 py-1  my-3 sm:my-6 ml-2 font-bold rounded-lg bg-slate-200 ">
                <a
                  href="#"
                  onClick={() => dispatch(PORK_MINUS(porkMenu))}
                ...
                <a
                  href="#"
                  onClick={() => dispatch(PORK_PLUS(porkMenu))}
          ...
          <div className="flex flex-col">
            <input
              type="checkbox"
              id={porkMenu.id}
              name={porkMenu.product_name}
              value={porkMenu.qty}
              checked={porkMenu.check}
              className="peer hidden"
              onChange={(e) => sent(e,{porkMenu})}
